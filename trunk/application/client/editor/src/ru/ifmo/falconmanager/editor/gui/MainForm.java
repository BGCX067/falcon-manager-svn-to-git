package ru.ifmo.falconmanager.editor.gui;
...
public class MainForm {
    ...
    private JToggleButton airportsCreateButton;
    private JToggleButton airportsEditButton;
    private JButton airportsDeleteButton;
    ...
    private JButton airplanesDeleteButton;
    private JToggleButton airplanesCreateButton;
    private JToggleButton airplanesEditButton;
    private JTable airplanesTable;
    private JButton airplaneSeatsDeleteButton;
    private JToggleButton airplaneSeatsCreateButton;
    private JToggleButton airplaneSeatsEditButton;
    ...
    private JButton flightsDeleteButton;
    ...
    private JToggleButton flightsCreateButton;
    private JToggleButton flightsEditButton;
    ...
    private ButtonGroup airplaneSeatsButtonGroup;
    private ButtonGroup airplanesButtonGroup;
    private ButtonGroup airportsButtonGroup;
...
//                    DatabaseSnapshot.getInstance().reloadAirplaneSeats();
    ...
    private void $$$setupUI$$$() {
        ...
        flightsCreateButton = new JToggleButton();
        flightsCreateButton.setText("Create");
        toolBar1.add(flightsCreateButton);
        flightsEditButton = new JToggleButton();
        flightsEditButton.setEnabled(false);
        flightsEditButton.setText("Edit");
        toolBar1.add(flightsEditButton);
        flightsDeleteButton = new JButton();
        flightsDeleteButton.setEnabled(false);
        flightsDeleteButton.setText("Delete");
        toolBar1.add(flightsDeleteButton);
        ...
        airplaneSeatsCreateButton = new JToggleButton();
        airplaneSeatsCreateButton.setEnabled(false);
        airplaneSeatsCreateButton.setText("Create");
        toolBar3.add(airplaneSeatsCreateButton);
        airplaneSeatsEditButton = new JToggleButton();
        airplaneSeatsEditButton.setEnabled(false);
        airplaneSeatsEditButton.setText("Edit");
        toolBar3.add(airplaneSeatsEditButton);
        airplaneSeatsDeleteButton = new JButton();
        airplaneSeatsDeleteButton.setEnabled(false);
        airplaneSeatsDeleteButton.setText("Delete");
        toolBar3.add(airplaneSeatsDeleteButton);
        ...
        airplanesCreateButton = new JToggleButton();
        airplanesCreateButton.setText("Create");
        toolBar4.add(airplanesCreateButton);
        airplanesEditButton = new JToggleButton();
        airplanesEditButton.setEnabled(false);
        airplanesEditButton.setText("Edit");
        toolBar4.add(airplanesEditButton);
        airplanesDeleteButton = new JButton();
        airplanesDeleteButton.setEnabled(false);
        airplanesDeleteButton.setText("Delete");
        toolBar4.add(airplanesDeleteButton);
        ...
        airportsCreateButton = new JToggleButton();
        airportsCreateButton.setSelected(false);
        airportsCreateButton.setText("Create");
        airportsCreateButton.setToolTipText("");
        toolBar5.add(airportsCreateButton);
        airportsEditButton = new JToggleButton();
        airportsEditButton.setEnabled(false);
        airportsEditButton.setSelected(false);
        airportsEditButton.setText("Edit");
        toolBar5.add(airportsEditButton);
        airportsDeleteButton = new JButton();
        airportsDeleteButton.setEnabled(false);
        airportsDeleteButton.setText("Delete");
        toolBar5.add(airportsDeleteButton);
        ...
        airportsButtonGroup = new ButtonGroup();
        airportsButtonGroup.add(airportsCreateButton);
        airportsButtonGroup.add(airportsEditButton);
        airplanesButtonGroup = new ButtonGroup();
        airplanesButtonGroup.add(airplanesCreateButton);
        airplanesButtonGroup.add(airplanesEditButton);
        airplaneSeatsButtonGroup = new ButtonGroup();
        airplaneSeatsButtonGroup.add(airplaneSeatsCreateButton);
        airplaneSeatsButtonGroup.add(airplaneSeatsEditButton);
        flightsButtonGroup = new ButtonGroup();
        flightsButtonGroup.add(flightsCreateButton);
        flightsButtonGroup.add(flightsEditButton);
